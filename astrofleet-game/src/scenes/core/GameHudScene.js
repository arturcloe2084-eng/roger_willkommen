...
export class GameHudScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.levelText = this.add.text(220, 10, `LVL: ${playerProgressStore.level}`, {
        ...
        this.wordsText = this.add.text(10, 60, `Palabras: ${playerProgressStore.learnedWords.length}`, {
            fontFamily: 'VT323',
            fontSize: '18px',
            fill: '#ffaa00'
        });

        this.dayText = this.add.text(10, 84, `Día: ${playerProgressStore.story.day}/30`, {
            fontFamily: 'VT323',
            fontSize: '18px',
            fill: '#88ddff'
        });
    ...
    updateHUD() {
        ...
        this.levelText.setText(`LVL: ${playerProgressStore.level}`);
        this.xpText.setText(`XP: ${playerProgressStore.xp}/${playerProgressStore.xpToNextLevel}`);
        this.wordsText.setText(`Palabras: ${playerProgressStore.learnedWords.length}`);
        this.dayText.setText(`Día: ${playerProgressStore.story.day}/30`);
